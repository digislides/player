...
import '../view.dart';
import 'package:player/utils/inner_html.dart';
...
class ClockComponent {
  ...
  final _hoursContiner = DivElement()
    ..classes.add('hours-container')
    ..children.add(DivElement()..classes.add('hours'));
  final _minutesContainer = DivElement()
    ..classes.add('minutes-container')
    ..children.add(DivElement()..classes.add('minutes'));
  final _secondsContainer = DivElement()
    ..classes.add('seconds-container')
    ..children.add(DivElement()..classes.add('seconds'));
